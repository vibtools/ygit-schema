---
title: VibTools Manifest (v1)
description: Official specification for vibtools.json manifests to automate project imports, catalogs, and GitHub repository synchronization.
order: 11
---
